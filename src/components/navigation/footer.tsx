...
const Footer = () => {
  return (
    <footer
        ...
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col items-start justify-start md:max-w-[200px]">
            <div className="flex items-start">
              <Link href="/#home">
                <Image src="/logo.svg" alt="logo" width={1920} height={682}
                       className="w-[120px] h-[40px] md:w-[142px] md:h-[50px]"/>
              </Link>
            </div>
      ...
      <div className="mt-8border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
